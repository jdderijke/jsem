...
class SDM72V2(SDM):
	...
	def __init__(self, *args, **kwargs):
		...
		# als fmt een list of dictionary is dan kan de gelezen waarde gebruikt worden als index (in geval van integer) of key...
		# met batch kun je een VOLGORDE bepalen waarin de registers ge-returned/gelezen moeten worden, 
		# de sortering is dan: Batch -> plek in self.registers
