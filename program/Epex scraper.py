...
for x in range(1, nbDays+1):
	...
	while(nbEl<1 and trials<=3):
        ...
        # https://www.epexspot.com/en/market-data?data_mode=table&modality=Auction&sub_modality=DayAhead&market_area=NL&product=60&delivery_date=2022-12-18&trading_date=2022-12-17
